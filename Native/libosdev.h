...
#define ICON_Main						000 // アプリケーションのアイコンです。
#define ICON_FormMain_v0_0_0_0			001 // メインウィンドウのアイコンです。       このアイコンは 0.0.0.0 で追加された物です。
#define ICON_Unknown_v0_0_0_0			002 // 不明である事を表すアイコンです。       このアイコンは 0.0.0.0 で追加された物です。
#define ICON_File_v0_0_0_0				003 // ファイルを表すアイコンです。           このアイコンは 0.0.0.0 で追加された物です。
#define ICON_BinaryFile_v0_0_0_0		004 // バイナリファイルを表すアイコンです。   このアイコンは 0.0.0.0 で追加された物です。
#define ICON_TextFile_v0_0_0_0			005 // テキストファイルを表すアイコンです。   このアイコンは 0.0.0.0 で追加された物です。
#define ICON_Folder_v0_0_0_0			006 // フォルダを表すアイコンです。           このアイコンは 0.0.0.0 で追加された物です。
#define ICON_FolderClose_v0_0_0_0		007 // 閉じているフォルダを表すアイコンです。 このアイコンは 0.0.0.0 で追加された物です。
#define ICON_FolderOpen_v0_0_0_0		008 // 開いているフォルダを表すアイコンです。 このアイコンは 0.0.0.0 で追加された物です。
