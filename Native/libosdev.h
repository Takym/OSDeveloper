...
#define ICON_ProgramFile_v0_0_0_0		13 // プログラムファイルを表すアイコンです。   このアイコンは 0.0.0.0 で追加された物です。
#define ICON_SourceCodeFile_v0_0_0_0	14 // ソースコードファイルを表すアイコンです。 このアイコンは 0.0.0.0 で追加された物です。
#define ICON_ResourceFile_v0_0_0_0		15 // リソースファイルを表すアイコンです。     このアイコンは 0.0.0.0 で追加された物です。
#define ICON_DocumentFile_v0_0_0_0		16 // ドキュメントファイルを表すアイコンです。 このアイコンは 0.0.0.0 で追加された物です。
