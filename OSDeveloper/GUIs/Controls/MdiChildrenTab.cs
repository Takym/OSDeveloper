...
namespace OSDeveloper.GUIs.Controls
{
	public partial class MdiChildrenTab : Control
	{
		...
		/// <summary>
		///  型'<see cref="OSDeveloper.GUIs.Controls.MdiChildrenTab"/>'の
		///  新しいインスタンスを生成します。
		/// </summary>
		...
		/// <summary>
		///  <see cref="OSDeveloper.GUIs.Controls.MdiChildrenTab.ButtonColor"/>プロパティを限定値にリセットします。
		/// </summary>
		...
		/// <summary>
		///  <see cref="OSDeveloper.GUIs.Controls.MdiChildrenTab.MouseActionButtonColor"/>プロパティを限定値にリセットします。
		/// </summary>
