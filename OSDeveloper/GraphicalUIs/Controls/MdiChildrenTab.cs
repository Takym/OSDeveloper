...
using OSDeveloper.GraphicalUIs.Design;
...
namespace OSDeveloper.GraphicalUIs.Controls
{
	public partial class MdiChildrenTab : Control
	{
		...
		/// </summary>
		public ColorTheme ButtonColor { get; set; }

		/// <summary>
		///  マウスイベントが発生しているタブボタンのカラーテーマを取得または設定します。
		/// </summary>
		public ColorTheme MouseActionButtonColor { get; set; }

		private readonly Logger _logger;
		private int _mouse_over, _click_index;

		/// <summary>
		///  型'<see cref="OSDeveloper.GraphicalUIs.Controls.MdiChildrenTab"/>'の
		///  新しいインスタンスを生成します。
		/// </summary>
		...
		/// <summary>
		///  <see cref="OSDeveloper.GraphicalUIs.Controls.MdiChildrenTab.ButtonColor"/>プロパティを限定値にリセットします。
		/// </summary>
		public void ResetButtonColor()
		{
			this.ButtonColor = ColorThemes.FreshBlue;
		}

		/// <summary>
		///  <see cref="OSDeveloper.GraphicalUIs.Controls.MdiChildrenTab.MouseActionButtonColor"/>プロパティを限定値にリセットします。
		/// </summary>
		public void ResetMouseActionButtonColor()
		{
			this.MouseActionButtonColor = ColorThemes.FreshCyan;
		}
